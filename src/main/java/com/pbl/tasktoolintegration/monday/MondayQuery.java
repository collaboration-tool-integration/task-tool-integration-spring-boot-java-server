...
public enum MondayQuery {
    ...
    MONDAY_GET_ALL_UPDATES_WITH_COMMENTS_PAGE("query { updates (page : %s) { item_id id creator_id created_at text_body updated_at replies { id creator_id created_at text_body updated_at } } }"),
