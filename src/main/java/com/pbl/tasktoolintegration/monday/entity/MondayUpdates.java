...
public class MondayUpdates {
    @Id
    private String id;

    @ManyToOne
    @JoinColumn(name = "monday_item_id", nullable = false)
    ...
    @Builder
    public MondayUpdates(String id, MondayItems mondayItem, MondayUsers mondayCreatorUser) {
        this.id = id;
